...
description: Select this agent for adding build systems (Makefile), containerization (Docker), cloud deployment configs, or distribution infrastructure to Go projects.
model: sonnet
color: yellow
---
