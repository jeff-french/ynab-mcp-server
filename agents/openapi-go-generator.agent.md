...
description: Select this agent for generating Go structs, types, and models from OpenAPI specifications with correct type mappings, validation, and idiomatic Go code patterns.
model: sonnet
color: red
---
